        ...
        <div class="row d-flex justify-content-center">
            ...
            @csrf
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="points" name="points" type="number" class="form-control @error('points') is-invalid @enderror" value="{{ old('points') }}">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select id="role_id" name="role_id" class="form-select @error('role_id') is-invalid @enderror">
                            ...
                            @foreach ($roles as $role)
                                <option value="{{ $role->role_id }}" @if (old('role_id') == $role->role_id) selected @endif>{{ $role->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select id="category_id" name="category_id" class="form-select @error('category_id') is-invalid @enderror">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->category_id }}" @if (old('category_id') == $category->category_id) selected @endif>{{ $category->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select id="sport_id" name="sport_id" class="form-select @error('sport_id') is-invalid @enderror">
                            ...
                            @foreach ($sports as $sport)
                                <option value="{{ $sport->sport_id }}" @if (old('sport_id') == $sport->sport_id) selected @endif>{{ $sport->name }}</option>
                            @endforeach
                        </select>
